...
define view entity ZV_RAP05_BOOKING_M
  as select from zvt_rap05_book_m
  composition [1..*] of ZV_RAP05_BOOKSPL_M as _Bookspl
  association to parent ZV_RAP05_TRAVEL_ROOT_M as _Travel on $projection.TravelId = _Travel.TravelId
